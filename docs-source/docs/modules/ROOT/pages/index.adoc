...
This guide helps you to get started with _Reactive_ principles and how they apply to Akka. It complements the {akka}[Akka reference documentation] {akka}[{tab-icon}, window="tab"] which presents all Akka features in detail.
...
For a code-first experience, have a look at the tutorial which walks you through an example project and explains how things in Akka fit together to build Reactive Systems. The tutorial will point you to the relevant xref::concepts:index.adoc[concepts] where applicable.
